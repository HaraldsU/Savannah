...
namespace Savannah
{
    ...
    {
        public static List<IPlugin> ReadExtensions()
        {
            ...
            foreach (var file in files)
            {
                ...
                var pluginTypes = assembly.GetTypes().Where(t => typeof(AnimalLibrary.Models.IPlugin).IsAssignableFrom(t) && !t.IsInterface).ToArray();
